...
namespace Salse
{
	class Result : INotifyPropertyChanged
	{
		...
		public Result()
		{
			_validationContext = new ValidationContext(this,null,null,null);
							Id = 0;
							Date = DateTime.Today;
							SectionId = 1;
							Client = string.Empty;
		...
		protected virtual void RaisePropertyChanged(string propertyName)
		{
			...
			[Range(1,byte.MaxValue,ErrorMessage ="指定可能な値の範囲外です")]
			...
			[StringLength(32,ErrorMessage="32文字以内で指定してください")]
